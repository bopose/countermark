...
IMAGE_SUFFIXES = (".png", ".jpg", ".jpeg", ".webp", ".avif", ".heic", ".heif")
...
def build_parser():
    ...
    add_common(p_c2pa, ".png, .jpg, .jpeg, .webp, .avif, .heic, .heif")
    ...
    add_common(p_verify, ".png, .jpg, .jpeg, .webp, .avif, .heic, .heif")
    ...
    add_common(p_bag, ".png, .jpg, .jpeg, .webp, .avif, .heic, .heif")
